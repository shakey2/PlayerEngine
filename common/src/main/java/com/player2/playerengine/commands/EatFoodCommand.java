...
public class EatFoodCommand extends Command {
   ...
   protected void call(PlayerEngineController controller, ArgParser parser) throws CommandException {
      ...
      // 1.21.1: ResourceLocation no longer has a new ResourceLocation(String) constructor;
      // use ResourceLocation.parse(String) which handles both "namespace:path" and bare "path" forms.
      String resourceString = itemNameAsString.contains(":") ? itemNameAsString : "minecraft:" + itemNameAsString;
      ResourceLocation location = ResourceLocation.parse(resourceString);
