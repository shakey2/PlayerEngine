...
public final class PlayerEngineClient {
    ...
    *
    * <p>1.20.1 buf class: {@code FriendlyByteBuf} (not {@code RegistryFriendlyByteBuf}).
    */
    ...
    * 1.20.1 buf class: {@code FriendlyByteBuf}.
    */
   private static void sendTtsSegmentDone(String botUuid, int segIndex) {
      ...
      mc.execute(() -> {
         ...
         FriendlyByteBuf segBuf = new FriendlyByteBuf(Unpooled.buffer());
