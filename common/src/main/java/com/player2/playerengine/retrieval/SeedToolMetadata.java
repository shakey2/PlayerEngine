    ...
    public static Collection<ToolDocument> all() {
        return List.of(
            ...
            doc("deposit",
                ...
                "Use to move items from the NPC's inventory into a container. Pass no arguments to deposit all non-tool items, or specify items and quantities to deposit a subset. Unlike 'stash', deposit automatically finds the nearest container without a coordinate range.",
