...
public class CharacterUtils {
   public static Character DEFAULT_CHARACTER = new Character(
      "default", "AI agent", "AI", "Greetings", "You are a helpful AI Agent", "minecraft:textures/entity/player/wide/steve.png", new String[0]
   );
         ...
         if (!responseMap.containsKey("characters")) {
            ...
            if (charactersArray.isEmpty()) {
               ...
               for (int i = 0; i < charactersArray.size(); i++) {
                  ...
                  String characterId = Utils.getStringJsonSafely(firstCharacter, "id");
                  if (characterId == null) {
                     characterId = Utils.getStringJsonSafely(firstCharacter, "character_id");
                  }
                  if (characterId == null) {
                     characterId = "";
                  }
                  ...
                  characters[i] = new Character(characterId, name, shortName, greeting, description, skinURL, voiceIds);
               }
   ...
   public static Character readFromBuf(FriendlyByteBuf buf) {
      ...
      return new Character(id, name, shortName, greetingInfo, description, skinURL, voiceIds);
   }
   ...
   public static void writeToNBT(CompoundTag compound, Character character) {
      compound.putString("id", character.id());
