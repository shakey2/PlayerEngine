...
public class DoToClosestBlockTask extends AbstractDoToClosestObjectTask<BlockPos> {
   ...
   protected Vec3 getPos(PlayerEngineController mod, BlockPos obj) {
      return WorldHelper.toVec3d(obj);
   }

   @Override
   protected Optional<BlockPos> getClosestTo(PlayerEngineController mod, Vec3 pos) {
   ...
   protected boolean isValid(PlayerEngineController mod, BlockPos obj) {
