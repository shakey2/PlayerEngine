...
public abstract class AbstractDoToClosestObjectTask<T> extends Task {
   ...
   protected abstract Vec3 getPos(PlayerEngineController var1, T var2);

   protected abstract Optional<T> getClosestTo(PlayerEngineController var1, Vec3 var2);

   protected abstract Vec3 getOriginPos(PlayerEngineController var1);
