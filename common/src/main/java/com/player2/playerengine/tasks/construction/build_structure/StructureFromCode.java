...
public class StructureFromCode {
    ...
    public static void runCode(String code, Consumer<SetBlockCommand> onSetBlock, PlayerEngineController mod)
            throws Exception {
    ...
    public static void buildStructureFromCode(String code, Consumer<SetBlockCommand> onSetBlock,
            Consumer<String> onErrString, Runnable onFinishSuccess, PlayerEngineController mod) {
        try {
